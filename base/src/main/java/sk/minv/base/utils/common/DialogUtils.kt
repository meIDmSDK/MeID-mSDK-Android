...
import sk.minv.base.ui.LoadingDialog
...
object DialogUtils {
    ...
    fun showLoadingDialog(fragmentManager: FragmentManager) {
        val loadingDialog: LoadingDialog = LoadingDialog.Builder().build()
        loadingDialog.show(fragmentManager, LoadingDialog::class.java.name)
    }

    fun hideLoadingDialog(fragmentManager: FragmentManager) {
        val fragment = fragmentManager.findFragmentByTag(LoadingDialog::class.java.name)
        if (fragment != null) {
            val infoDialog: LoadingDialog = fragment as LoadingDialog
            infoDialog.dismiss()
        }
    }
}